const DEFAULT_DATA = {
    ...
    equipment: [
        ...
        /* -------- ANIMAIS E ARREIOS -------- */
        { id: 'eq_horse', category: 'Utilidades', name: 'Cavalo', cost: 300, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Montaria' },
        { id: 'eq_warhorse', category: 'Utilidades', name: 'Cavalo de Guerra', cost: 750, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Montaria Treinada' },
        { id: 'eq_saddle', category: 'Utilidades', name: 'Sela', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 5' },
        { id: 'eq_fancy_saddle', category: 'Utilidades', name: 'Sela Elaborada', cost: 50, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 5' },

        /* -------- EQUIPAMENTO DE AVENTURA -------- */
        { id: 'eq_shackles', category: 'Utilidades', name: 'Algemas (grilhões)', cost: 15, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_quiver', category: 'Utilidades', name: 'Aljava', cost: 25, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Acomoda 20 flechas. Peso: 1' },
        { id: 'eq_whistle', category: 'Utilidades', name: 'Apito', cost: 2, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '' },
        { id: 'eq_cam_disp', category: 'Utilidades', name: 'Câmera (descartável)', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_cam_digi', category: 'Utilidades', name: 'Câmera (digital)', cost: 300, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_cam_norm', category: 'Utilidades', name: 'Câmera (normal)', cost: 75, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_canteen', category: 'Utilidades', name: 'Cantil (odre)', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_blanket', category: 'Utilidades', name: 'Cobertor', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 2' },
        { id: 'eq_rope_hemp', category: 'Utilidades', name: 'Corda de cânhamo', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '20 metros. Peso: 7.5' },
        { id: 'eq_rope_nylon', category: 'Utilidades', name: 'Corda de nylon', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '20 metros. Peso: 1.5' },
        { id: 'eq_flask', category: 'Utilidades', name: 'Frasco (cerâmica)', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_grapple', category: 'Utilidades', name: 'Gancho de Escalada', cost: 100, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_lockpicks_util', category: 'Utilidades', name: 'Gazuas', cost: 200, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_umbrella', category: 'Utilidades', name: 'Guarda-Chuva', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_lighter', category: 'Utilidades', name: 'Isqueiro', cost: 2, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '' },
        { id: 'eq_tools', category: 'Utilidades', name: 'Kit de Ferramentas', cost: 200, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 2.5' },
        { id: 'eq_firstaid', category: 'Utilidades', name: 'Kit de Primeiros Socorros', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Três usos. Peso: 0.5' },
        { id: 'eq_medkit', category: 'Utilidades', name: 'Kit Médico', cost: 100, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '+1 em Curar. Cinco usos ($25 recarga). Peso: 2' },
        { id: 'eq_oil_lantern', category: 'Utilidades', name: 'Lamparina', cost: 25, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '4 horas, 4 quadros raio. Peso: 1.5' },
        { id: 'eq_flashlight', category: 'Utilidades', name: 'Lanterna', cost: 20, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '10 quadros feixe. Peso: 1.5' },
        { id: 'eq_hammer', category: 'Utilidades', name: 'Martelo', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_backpack2', category: 'Utilidades', name: 'Mochila', cost: 50, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_glasses', category: 'Utilidades', name: 'Óculos', cost: 20, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_oil', category: 'Utilidades', name: 'Óleo (meio litro)', cost: 2, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_shovel', category: 'Utilidades', name: 'Pá', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 2.5' },
        { id: 'eq_crowbar', category: 'Utilidades', name: 'Pé de Cabra', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_flint', category: 'Utilidades', name: 'Pederneira e Aço', cost: 3, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_whetstone', category: 'Utilidades', name: 'Pedra de Amolar', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_soap', category: 'Utilidades', name: 'Sabão', cost: 1, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.1' },
        { id: 'eq_sleepingbag', category: 'Utilidades', name: 'Saco de dormir', cost: 25, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Cobreter de inverno. Peso: 2' },
        { id: 'eq_torch', category: 'Utilidades', name: 'Tocha', cost: 5, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '1 hora (4 quadros de raio). Peso: 0.5' },
        { id: 'eq_candle', category: 'Utilidades', name: 'Vela', cost: 1, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '1 hora (2 quadros de raio). Peso: 0.5' },

        /* -------- VESTUÁRIO -------- */
        { id: 'eq_winter_boots', category: 'Utilidades', name: 'Vestuário: Botas de Inverno', cost: 100, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_hiking_boots', category: 'Utilidades', name: 'Vestuário: Botas, Caminhada', cost: 100, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_winter_gear', category: 'Utilidades', name: 'Equipamento de Inverno', cost: 200, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Capa/Jaqueta. Peso: 1.5' },
        { id: 'eq_camo', category: 'Utilidades', name: 'Vestuário Camuflado', cost: 20, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1.5' },
        { id: 'eq_casual', category: 'Utilidades', name: 'Vestuário, Casual', cost: 20, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1' },
        { id: 'eq_formal', category: 'Utilidades', name: 'Vestuário, Formal', cost: 200, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 1.5' },
        ...
        { id: 'eq_fastfood', category: 'Utilidades', name: 'Refeição Fast Food', cost: 8, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_goodmeal', category: 'Utilidades', name: 'Boa Refeição (Restaurante)', cost: 15, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '' },
        { id: 'eq_mre', category: 'Utilidades', name: 'RPC (Refeição Pronta para Comer)', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Peso: 0.5' },
        { id: 'eq_rations', category: 'Utilidades', name: 'Rações de Viagem', cost: 10, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: '5 refeições, dura 1 semana. Peso: 2.5' },
        
        { id: 'eq_stun_gun', category: 'Utilidades', name: 'Arma Atordoante', cost: 25, armor: 0, damage: 'Atordoar', minStr: 0, requiresAmmo: false, extraBenefits: 'Dist. 1/2/4. 3 tiros/carga (2h regarcar). Vigor -2 ou Atordoa. Peso: 0.25' },
        { id: 'eq_pepperspray', category: 'Utilidades', name: 'Spray de Pimenta', cost: 15, armor: 0, damage: 'Atordoar', minStr: 0, requiresAmmo: false, extraBenefits: 'Sem pen. distância; Máximo 2 quadros(4 metros). 5 Tiros. Vigor -2. Peso: 0.25' },
        ...
        { id: 'eq_repair_phone', category: 'Utilidades', name: 'Telefone de Reparos', cost: 150, armor: 0, damage: '-', minStr: 0, requiresAmmo: false, extraBenefits: 'Rola Consertar para conectar na linha. Peso: 2' },
